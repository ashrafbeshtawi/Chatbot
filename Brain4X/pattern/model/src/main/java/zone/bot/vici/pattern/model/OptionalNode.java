...
@Immutable
public class OptionalNode extends BotPatternNode {

	@Nonnull
	private final BotPatternNode child;

	public OptionalNode(@Nullable final List<BotPatternEntity> namedEntities, @Nonnull final BotPatternNode child) {
		super(namedEntities);
