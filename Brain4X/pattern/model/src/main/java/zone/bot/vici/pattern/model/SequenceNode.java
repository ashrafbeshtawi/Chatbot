...
@Immutable
public class SequenceNode extends BotPatternNode {

	@Nonnull
	private final List<BotPatternNode> children;

	public SequenceNode(@Nullable final List<BotPatternEntity> namedEntities, @Nonnull final List<BotPatternNode> children) {
		super(namedEntities);
